...
class Alien(Actor):
    ...
    TYPES = {
        '1': (load_animation('C:\\Coding\\kyunghee\\게임프로그래밍입문\\4_CocosInvaders\\img\\alien1.png'), 40),
        '2': (load_animation('C:\\Coding\\kyunghee\\게임프로그래밍입문\\4_CocosInvaders\\img\\alien1.png'), 20),
        '3': (load_animation('C:\\Coding\\kyunghee\\게임프로그래밍입문\\4_CocosInvaders\\img\\alien1.png'), 10)
    }
