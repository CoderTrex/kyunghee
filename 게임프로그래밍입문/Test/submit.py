...
class Minesweeper:
    ...
    def __init__(self, tk):
        ...
        # import images
        self.images = {
            "plain": PhotoImage(file = "C:\\Coding\\github\\kyunghee\\게임프로그래밍입문\\Test\\python-tkinter-minesweeper-master\\python-tkinter-minesweeper-master\\images\\tile_plain.gif"),
            "clicked": PhotoImage(file = "C:\\Coding\\github\\kyunghee\\게임프로그래밍입문\\Test\\python-tkinter-minesweeper-master\\python-tkinter-minesweeper-master\\images\\tile_clicked.gif"),
            "mine": PhotoImage(file = "C:\\Coding\\github\\kyunghee\\게임프로그래밍입문\\Test\\python-tkinter-minesweeper-master\\python-tkinter-minesweeper-master\\images\\tile_mine.gif"),
            "flag": PhotoImage(file = "C:\\Coding\\github\\kyunghee\\게임프로그래밍입문\\Test\\python-tkinter-minesweeper-master\\python-tkinter-minesweeper-master\\images\\tile_flag.gif"),
            "wrong": PhotoImage(file = "C:\\Coding\\github\\kyunghee\\게임프로그래밍입문\\Test\\python-tkinter-minesweeper-master\\python-tkinter-minesweeper-master\\images\\tile_wrong.gif"),
            "numbers": []
        }
        for i in range(1, 9):
            self.images["numbers"].append(PhotoImage(file = "C:\\Coding\\github\\kyunghee\\게임프로그래밍입문\\Test\\python-tkinter-minesweeper-master\\python-tkinter-minesweeper-master\\images\\tile_"+str(i)+".gif"))
