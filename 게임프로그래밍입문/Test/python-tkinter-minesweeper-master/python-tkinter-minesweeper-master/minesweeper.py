...
class Minesweeper:
    ...
    def __init__(self, tk):
        ...
        # import images
        self.images = {
            "plain": PhotoImage(file = "python-tkinter-minesweeper-master\\images\\tile_plain.gif"),
            "clicked": PhotoImage(file = "python-tkinter-minesweeper-master\\images\\tile_clicked.gif"),
            "mine": PhotoImage(file = "python-tkinter-minesweeper-master\\images\\tile_mine.gif"),
            "flag": PhotoImage(file = "python-tkinter-minesweeper-master\\images\\tile_flag.gif"),
            "wrong": PhotoImage(file = "python-tkinter-minesweeper-master\\images\\tile_wrong.gif"),
            "numbers": []
        }
        for i in range(1, 9):
            self.images["numbers"].append(PhotoImage(file = "python-tkinter-minesweeper-master\\images\\tile_"+str(i)+".gif"))
