...
private:
  NodeType_Q<ItemType>* front;
  NodeType_Q<ItemType>* rear;
};
...
{
  NodeType_Q<ItemType>* location;
  try
  {
    location = new NodeType_Q<ItemType>;
    delete location;
    return false;
  }
...

{
  ...
  {
    NodeType_Q<ItemType>* newNode;

    newNode = new NodeType_Q<ItemType>;
